          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-start">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-brand-teal/10 border border-brand-teal/20 flex items-center justify-center text-brand-teal mr-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md relative overflow-hidden">
              ...
              <div className="relative flex justify-center mb-8">
                <div className="w-48 h-48 rounded-full border border-dashed border-brand-teal/40 flex items-center justify-center animate-spin-slow">
                  <div className="w-36 h-36 rounded-full border border-brand-teal/20 flex items-center justify-center">
                    <div className="w-24 h-24 rounded-full bg-brand-teal/10 flex items-center justify-center border border-brand-teal/30">
                ...
                <div className="absolute top-8 left-12 w-3 h-3 bg-brand-teal/50 rounded-full animate-ping" />
                <div className="absolute bottom-6 right-16 w-2 h-2 bg-brand-teal rounded-full animate-bounce" />
                <div className="absolute top-1/2 right-6 w-3.5 h-3.5 bg-brand-teal/45 rounded-full animate-pulse" />
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
                  <div className="text-left">
                    ...
                    <div className="text-[10px] text-neutral-500 uppercase tracking-widest mt-0.5">Szabadalom</div>
                  </div>
                  <div className="text-left">
                    <div className="text-2xl font-bold text-brand-teal">3M+</div>
                    <div className="text-[10px] text-neutral-500 uppercase tracking-widest mt-0.5">Elégedett Ügyfél</div>
                  </div>
                </div>
              </div>
