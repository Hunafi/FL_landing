      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight leading-tight text-brand-slate">
              A szabadalmaztatott NTC® Koncepció:<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-teal to-rose-600">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white dark:bg-brand-green-dark border border-neutral-200/80 dark:border-neutral-800 rounded-3xl p-8 shadow-lg relative overflow-hidden">
              ...
              <div className="relative flex justify-center mb-8">
                <div className="w-48 h-48 rounded-full border border-dashed border-brand-teal/30 flex items-center justify-center animate-spin-slow">
                  <div className="w-36 h-36 rounded-full border border-brand-teal/20 flex items-center justify-center">
                    <div className="w-24 h-24 rounded-full bg-brand-teal/5 flex items-center justify-center border border-brand-teal/20">
                ...
                <div className="absolute top-8 left-12 w-3 h-3 bg-brand-teal/30 rounded-full animate-ping" />
                <div className="absolute bottom-6 right-16 w-2 h-2 bg-brand-teal/60 rounded-full animate-bounce" />
                <div className="absolute top-1/2 right-6 w-3.5 h-3.5 bg-brand-teal/40 rounded-full animate-pulse" />
              </div>
