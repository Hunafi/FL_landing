...
export default function Lifestyle() {
  return (
    <section className="py-20 md:py-28 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-1/2 right-0 -translate-y-1/2 w-72 h-72 bg-brand-gold-light/25 rounded-full blur-3xl -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 grid grid-cols-12 gap-4 relative">
            ...
            <div className="col-span-4 self-end relative aspect-square rounded-2xl overflow-hidden shadow-2xl border-4 border-white translate-y-6 -translate-x-8">
              <Image
            ...
            {/* Float badge */}
            <div className="absolute -top-4 right-12 bg-brand-gold text-white text-xs font-bold px-4 py-2 rounded-full shadow-lg border border-white/10">
          ...
          <div className="lg:col-span-6 space-y-6 lg:pl-6">
            ...
            <h3 className="text-3xl sm:text-4xl font-extrabold text-brand-green-dark tracking-tight leading-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
              <div className="space-y-2">
                <h4 className="font-bold text-brand-green-dark text-base">Csak napi 2 perc</h4>
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-brand-green-dark text-base">Finom ízek, nulla sóvárgás</h4>
                <p className="text-xs text-neutral-500 font-light leading-relaxed">
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-brand-green-dark text-base">Megtartott izomtömeg</h4>
                <p className="text-xs text-neutral-500 font-light leading-relaxed">
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-brand-green-dark text-base">Jobb közérzet</h4>
                <p className="text-xs text-neutral-500 font-light leading-relaxed">
