export default function FinalCta() {
  return (
    <section className="py-20 md:py-24 bg-brand-green-dark text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(13,148,136,0.18),transparent_70%)]" />
      
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-8">
        
        <div className="space-y-4 max-w-3xl mx-auto">
          <h2 className="text-xs font-bold text-brand-gold uppercase tracking-widest">Kezdje el még ma</h2>
