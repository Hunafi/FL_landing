export default function TrustBar() {
  return (
    <div className="bg-white dark:bg-[#121214] border-y border-neutral-200 dark:border-neutral-800/80 py-8 relative z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 items-center text-center">
          
          {/* Made in Germany */}
          <div className="flex flex-col items-center space-y-2 group">
            <div className="w-12 h-12 rounded-full bg-neutral-50 dark:bg-[#0a0a0a] flex items-center justify-center border border-neutral-100 dark:border-neutral-800/60 group-hover:bg-brand-gold-light/40 dark:group-hover:bg-brand-teal/20 transition-colors duration-300">
              <svg className="w-6 h-6 text-brand-green-mid dark:text-brand-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
