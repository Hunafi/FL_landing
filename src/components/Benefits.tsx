  ...
  const benefitList = [
    {
      ...
      description: "Nincs jojó-effektus. A termékek nem a zsírégetést és izommegtartást célozzák vízveszteség helyett.",
      icon: (
    ...
    {
      title: "Glutén- & Laktózmentes Biztonság",
      description: "Termékeink tiszta, laktóz- és gluténmentes receptúrák alapján készülnek. Minden terméket független laboratóriumok vizsgálnak, és szerepelnek a Kölni Listán.",
      icon: (
        <svg className="w-6 h-6 text-brand-teal group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h3 className="text-3xl sm:text-4xl font-extrabold text-brand-slate tracking-tight">
            A Prémium Különbség: Miért Minket Válasszon?
          </h3>
