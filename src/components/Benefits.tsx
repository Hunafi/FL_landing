      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefitList.map((benefit, index) => (
            ...
            >
              <div className="w-12 h-12 rounded-2xl bg-white border border-neutral-100 flex items-center justify-center shadow-xs group-hover:bg-brand-teal group-hover:text-white group-hover:border-transparent transition-all duration-300 shrink-0">
                <span className="group-hover:text-white transition-colors duration-300">
                  {benefit.icon}
                </span>
              </div>
              <h3 className="text-lg font-bold text-brand-green-dark mt-6 mb-3">
                {benefit.title}
              </h3>
              <p className="text-sm text-neutral-600 font-light leading-relaxed flex-grow">
                {benefit.description}
              </p>
            </div>
          ))}
