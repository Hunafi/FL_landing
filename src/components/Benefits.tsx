export default function Benefits() {
  const benefitList = [
    ...
    },
    {
      ...
      description: "Termékeink tiszta, laktóz- és gluténmentes receptúrák alapján készülnek. Minden FitLine terméket független laboratóriumok vizsgálnak, és szerepelnek a Kölni Listán.",
      icon: (
        <svg className="w-6 h-6 text-brand-teal group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
